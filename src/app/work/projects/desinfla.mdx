...
summary: "A cross-platform mobile app built with React Native that delivers personalized daily and weekly meal plans for weight loss using ready-to-eat supermarket products. The app integrates iOS and Android subscriptions, authentication with Apple and Google, and a Firebase backend for user management, content delivery, and plan personalization, focusing on performance, scalability, and a smooth user experience."
images:
  - "/images/projects/desinfla/cover.png"
team:
  - name: "Herson Chur"
