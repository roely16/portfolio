...
summary: "A mobile app focused on turning Catalan learning into a daily and engaging habit, promoting the natural use of the language in the digital era.

The project includes migration to mobile using Capacitor, integration of push notifications for iOS and Android, and camera-based AI image recognition to enable interactive, real-world learning experiences. Additional improvements were made to ensure App Store and Google Play compliance, supporting a smooth publication process."
images:
  - "/images/projects/project-01/buscamot-01.png"
team:
  - name: "Herson Chur"
