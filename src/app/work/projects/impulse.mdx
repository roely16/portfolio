...
summary: "Impulse is a focus and productivity app designed to help users regain control of their attention by blocking distracting apps and websites during specific time slots. By limiting access based on schedules, days, or the number of allowed app launches, Impulse enables more intentional and focused device usage.

The app was developed using React Native for iOS, with multiple custom native modules built to support advanced app-blocking functionality. A key technical challenge was implementing system-level restrictions without developing the app fully natively, requiring deep integration between React Native and iOS native APIs to ensure reliability, performance, and a seamless user experience."
images:
  - "/images/projects/impulse/cover.png"
team:
  - name: "Herson Chur"
